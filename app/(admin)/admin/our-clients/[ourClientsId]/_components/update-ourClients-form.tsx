...
export const UpdateOurClientsForm = ({ data }: UpdateOurClientsFormProps) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.patch(`/api/industries/${data?.id}`, values);
  ...
  return (
    <>
      <div className="max-w-3xl mx-auto mt-10">
        <h1 className="text-2xl">Update industries page</h1>
        <Form {...form}>
          <form
