...
export const AddIndustriesForm = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.post("/api/industries", values);
      toast.success("Industries page Added");
  ...
  return (
    <>
      <div className="max-w-3xl mx-auto mt-10">
        <h1 className="text-2xl">Add new industries page</h1>
        <Form {...form}>
          <form
