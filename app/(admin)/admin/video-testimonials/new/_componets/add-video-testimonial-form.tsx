...
const formSchema = z.object({
  ...
  videoUrl: z
    ...
    .refine((v) => youtubeUrl(v), { message: "Enter a valid YouTube URL" }),
...
export const AddVideoTestimonialForm = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.post("/api/video-testimonial", values);
    ...
    <>
      <div className="flex items-center justify-between pb-3">
        <Heading
          ...
          description="Add a new Video testimonial."
        />
      </div>
      <Separator />
      <Form {...form}>
