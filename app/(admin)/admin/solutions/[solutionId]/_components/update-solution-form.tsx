...
import { Services, Solutions } from "@prisma/client";
...
export const UpdateSolutionForm = ({ data }: UpdateSolutionFormProps) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.patch(`/api/solutions/${data?.id}`, values);
      toast.success("Solution page updated");
  ...
  return (
    <>
      <div className="max-w-3xl mx-auto mt-10">
        <h1 className="text-2xl">Update solution page</h1>
        <Form {...form}>
          <form
