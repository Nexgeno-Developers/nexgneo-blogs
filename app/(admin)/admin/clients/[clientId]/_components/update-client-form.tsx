...
export const UpdateClientForm = ({ data }: UpdateClientFormProps) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.patch(`/api/clients/${data?.id}`, values);
  ...
  return (
    <>
      <div className="flex items-center justify-between pb-3">
        <Heading title="Edit Client" description="Edit client information." />
      </div>
      <Separator />
      <Form {...form}>
