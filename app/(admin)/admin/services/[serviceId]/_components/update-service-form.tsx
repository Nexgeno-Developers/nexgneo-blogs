...
const formSchema = z.object({
  ...
  whyChooseItems: z.array(cardSchema).min(1, "Add at least one Why Choose card"),
...
// Parse existing Why Choose items (support legacy JSON-in-string if needed)
  const parsedWhyChooseItems: { image: string; title: string; desc: string }[] = (() => {
    if (Array.isArray((data as any)?.whyChooseItems)) return (data as any).whyChooseItems;
    try {
  ...
  const parsedProcessItems: { image: string; title: string; desc: string }[] = (() => {
    if (Array.isArray((data as any)?.processItems)) return (data as any).processItems;
    return [];
  })();

  const parsedFaqItems: { title: string; desc: string }[] = Array.isArray((data as any)?.faqItems)
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      // Why Choose
      whyChoose:
        data?.whyChoose && typeof data.whyChoose === "string" && !data.whyChoose.startsWith("[")
          ? data.whyChoose
          : "Why Choose Nexgeno?",
      whyChooseItems:
      ...
      faqItems: parsedFaqItems.length ? parsedFaqItems : [{ title: "", desc: "" }],
      showInMenu: data?.showInMenu ?? false, // Set default to false
    },
  });

  const { isSubmitting } = form.formState;
const items = useFieldArray({ control: form.control, name: "whyChooseItems" });
  const procArray = useFieldArray({ control: form.control, name: "processItems" });  
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input disabled={isSubmitting} placeholder="Title" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea disabled={isSubmitting} placeholder="Description" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input disabled={isSubmitting} placeholder="e.g. Get Started" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input disabled={isSubmitting} placeholder="Alt Tag" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
...
<section className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input disabled={isSubmitting} placeholder="e.g. web-application" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input disabled={isSubmitting} placeholder="Meta Title" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea disabled={isSubmitting} placeholder="Meta Description" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <section className="shadow-md p-8 pt-5 space-y-8">
              <div className="flex items-center justify-between mt-2">
                ...
                <Button
                  type="button"
                  variant="secondary"
                  onClick={() => items.append({ image: "", title: "", desc: "" })}
                  disabled={isSubmitting}
                  className="gap-2"
                >
                ...
                {items.fields.map((field, index) => (
                  <div key={field.id} className="border">
                    <div className="flex flex-row items-center justify-between p-4">
                      <div className="text-base font-semibold">Why Choose Box #{index + 1}</div>
                      <Button
                        type="button"
                        variant="ghost"
                        size="icon"
                        ...
                        title={items.fields.length === 1 ? "At least one card required" : "Remove this card"}
                      >
                        <X className="h-4 w-4" />
                      </Button>
                    </div>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Title</FormLabel>
                              <FormControl>
                                <Input disabled={isSubmitting} placeholder="e.g. Built for relevance" {...field} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
            ...
            <section className="shadow-md p-8 pt-5 space-y-8">
              <div className="flex items-center justify-between mt-2">
                ...
                <Button
                  type="button"
                  variant="secondary"
                  onClick={() => procArray.append({ image: "", title: "", desc: "" })}
                  disabled={isSubmitting}
                  className="gap-2"
                >
              ...
              <div className="grid gap-6">
                {procArray.fields.map((field, index) => (
                  <div key={field.id} className="border">
                    <div className="flex flex-row items-center justify-between p-4">
                      <div className="text-base font-semibold">Step #{index + 1}</div>
                      <Button
                        type="button"
                        variant="ghost"
                        size="icon"
                        onClick={() => procArray.remove(index)}
                        disabled={isSubmitting || procArray.fields.length === 1}
                        title={procArray.fields.length === 1 ? "At least one step required" : "Remove"}
                      >
                        <X className="h-4 w-4" />
                      </Button>
                    </div>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input disabled={isSubmitting} placeholder="e.g. Discovery" {...field} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
  ...
  <div className="grid gap-6">
    {faqArray.fields.map((field, index) => (
      <div key={field.id} className="border">
        <div className="flex flex-row items-center justify-between p-4">
          <div className="text-base font-semibold">FAQ #{index + 1}</div>
          <Button
            type="button"
            variant="ghost"
            size="icon"
            ...
            title={faqArray.fields.length === 1 ? "At least one FAQ required" : "Remove"}
          >
            <X className="h-4 w-4" />
          </Button>
        </div>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Title</FormLabel>
                <FormControl>
                  <Input disabled={isSubmitting} placeholder="e.g. What services do you offer?" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
