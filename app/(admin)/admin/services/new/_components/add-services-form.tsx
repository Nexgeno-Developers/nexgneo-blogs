...
export const AddServicesForm = ({
  ...
  const whyChooseArray = useFieldArray({
              ...
              <section className="shadow-md p-8 pt-5 space-y-8">
                <div className="flex items-center justify-between mt-2">
                  ...
                  <Button
                    ...
                    variant="secondary"
                    onClick={() =>
                      whyChooseArray.append({ image: "", title: "", desc: "" })
                    }
                    disabled={isSubmitting}
                    className="gap-2"
                  >
                    ...
                    <div key={field.id} className="border">
                      <div className="flex flex-row items-center justify-between p-4">
                        ...
                        <Button
                          ...
                          variant="ghost"
                          size="icon"
                          onClick={() => whyChooseArray.remove(index)}
                          disabled={
                            isSubmitting || whyChooseArray.fields.length === 1
                          }
                          title={
                            whyChooseArray.fields.length === 1
                    ...
                    <div key={field.id} className="border">
                      <div className="flex flex-row items-center justify-between p-4">
                        ...
                        <Button
                          ...
                          disabled={
                            isSubmitting || processArray.fields.length === 1
                          }
                          title={
                            processArray.fields.length === 1
