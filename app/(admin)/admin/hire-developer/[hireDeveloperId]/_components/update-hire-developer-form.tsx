...
interface UpdateHireDeveloperFormProps {
  data: HireDeveloper | null;
}
...
export const UpdateHireDeveloperForm = ({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.patch(`/api/hire-developer/${data?.id}`, values);
      toast.success("Hire developer page updated");
      router.push("/admin/hire-developer");
      router.refresh();
    } catch (error) {
  ...
  return (
    <>
      <div className="max-w-3xl mx-auto mt-10">
        <h1 className="text-2xl">Update hire developer page</h1>
        <Form {...form}>
          <form
