...
export const AddHireDeveloperForm = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.post("/api/hire-developer", values);
      toast.success("Hire developer page added");
  ...
  return (
    <>
      <div className="max-w-3xl mx-auto mt-10">
        <h1 className="text-2xl">Add New Hire Developer Page</h1>
        <Form {...form}>
          <form
